<script>
  ...
  let randomizeRatio = $state(true);
  let ratioRangePercent = $state(10);
  ...
  function applyPreset(preset) {
    ...
    if (s.ratioRangePercent != null) ratioRangePercent = s.ratioRangePercent;
  ...
  function buildConfig() {
    ...
    config.baseConfig = {
      ...
      randomizeRatio: stopAtRatioEnabled ? randomizeRatio : undefined,
      ratioRangePercent: stopAtRatioEnabled ? parseFloat(ratioRangePercent) : undefined,
      stopAtUploadedEnabled,
